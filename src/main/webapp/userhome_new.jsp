...
<div class="ul" id="ul">
    ...
    <canvas id="canvas3"
            style="opacity:50%; position: relative; width:100%; height: 30%;  left: 0%; top: 22%; transform: rotateX(-132deg); filter: blur(2px)">
...
<canvas id="canvas2"
        style="position:relative; width:100%; height:20%; filter: blur(1px); float: left;   top: -49%; transform: rotateX(-180deg)">
</canvas>


<canvas id="canvas5"
        style="position:relative; width:100%; height: 21%; float: left; filter: blur(0px); color: white;   top: -55%; transform: rotateX(-180deg)">
</canvas>


<canvas id="canvas" style=" display: none; position:absolute; transform: rotateY(180deg);:  top: 5%">
    ...
    window.onload = function () {
        ...
        file.onchange = function () {
            ...
            function renderFrame() {
                ...
                ctx5.fillRect(10000, -1110, WIDTH, HEIGHT);
                ...
                for (var i = 0; i < bufferLength; i++) {
                    ...
                    ctx2.fillStyle = "rgb(" + b + "," + r + "," + r + ")"; //brr - white  //rrg- yellow //gbb-blue(goluboi(
                    ctx2.fillRect(x * 2, HEIGHT - barHeight, barWidth / 0.6, barHeight + 40);
