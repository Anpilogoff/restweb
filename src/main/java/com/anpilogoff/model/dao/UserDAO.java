...
//                    user.setEmail(user.getEmail());
                    System.out.println(user+ " user   FROM REGISTRATION SERVLET");
                  //  return user;
                }
            }
    ...
    public JsonArray loginUser(String login, String password) throws SQLException {
        ...
        System.out.println(IS_DB_CONTAIN_USER);
       ...
       Connection connection = getPoolConnection();
        System.out.println(connection + " from poo;");
        ...
        if (connection != null) {
            ...
            if (nickname != null && loginx != null && passwordx != null) {
                ...
                if (resultSet != null) {
                    ...
                    System.out.println(connection.isClosed() +      ": connection from login method isClosed");
                    statement.close();
                    connection.close();
                    System.out.println(name + " " + surname + " " + gender + " " + country);

                }
            }else{
                System.out.println("result is NULLLLL");
                return null;
            }
        }
    ...
    public String uploadPhoto(String nickname, String file_name) {
        ...
        try {
            ...
            if (result == 1) {
                ...
                statement.close();
                connection.close();
                System.out.println("successfully inserted in photo name in avatar table");
            } else {
                log.warn("A problem occured during inserting avatar-file-name into table 'avatars'");
                System.out.println("A problem occured during inserting avatar-file-name into table 'avatars'");
                return null;
            }
    ...
    public String getUserAvatar(String nickname) {
        ...
        System.out.println("resultset   " + file_name);
